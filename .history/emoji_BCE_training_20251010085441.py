...
inputs = load_npz("emoji_ai_requirements/ai_emoji_input_vector.npz")  # gives 28-long emotion vectors

answer_sheet = np.load("emoji_lookup.npz")
epochs = 1000000
...
for emoji in emojis:
    ...
    for epoch in epochs:
        ...
        grad_w = errors * lr_w * weights  # still negative
        grad_b = errors * lr_b
        weights -= grad_w  # subtract a negative
