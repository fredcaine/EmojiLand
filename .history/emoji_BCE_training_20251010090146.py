...
inputs = np.load("emoji_ai_requirements/ai_emoji_input_vector.npz")  # gives 28-long emotion vectors

answer_sheet = np.load("emoji_ai_requirements/emoji_lookup.npz")
epochs = 1000000
