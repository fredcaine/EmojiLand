...
inputs = ("emoji_ai_requirements/ai_emoji_input_vector.npz")["arr_0"]  # gives 28-long emotion vectors
...
for emoji in emojis:
    ...
    for epoch in range(epochs):
        ...
        grad_w = inputs.T.dot(errors).reshape(-1, 1) / inputs.shape[0]  # negative for a guess that's too low, positive for a guess that's too high
