...
for emoji in emojis:
    ...
    for epoch in range(epochs):
        ...
        # y_pred is flattened such that it matches y_true, which is a list and therefore (doccount,1)
        errors = y_pred.flatten() - y_true  # rewards confident answers linearly. this is the partial derivative of the BCE loss function
        print(errors.shape, inputs.shape)
