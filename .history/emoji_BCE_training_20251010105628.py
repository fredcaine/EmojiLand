...
for emoji in emojis:
    ...
    bias = 0
    y_true = np.array(answer_sheet[:,emojis.index(emoji)])  # [:,x] slices to extract column x (0-indexed, as is .index)
    # made an array (doccount,1) to make multiplication easier later
