...
# 1) I added weighting to the loss function. This however, is notably useless.
...
for emotion in emotions:
    ...
    # # This following segment is specifically for *beginning* training.
    # current_epochs = 0
...
# Here is a, much more standard, method, where calculations are done in batches.
    for epoch in range(epochs):
        ...
        # Again, y_true is flattened: np.array(list) --> a filtered array.
