...
while True:
    ...
    # We go through all the returned values.
    for item in emotion_dicts.copy():
        formatted_item = str(item)
        # If they are dictionaries (str(item) doesn't cast, it returns a string):
        if type(item) == dict:
